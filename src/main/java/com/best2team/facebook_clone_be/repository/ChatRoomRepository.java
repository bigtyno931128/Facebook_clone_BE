...
import com.best2team.facebook_clone_be.websocket.RedisSubscriber;
...
public class ChatRoomRepository {
    ...
    public ChatRoomDto createChatRoom(ChatRequestDto chatRequestDto) {
        ChatRoomDto chatRoom = ChatRoomDto.create(chatRequestDto.getPublisher(), chatRequestDto.getSubscriber());
